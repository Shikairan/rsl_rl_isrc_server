...
| 3 | login 也带地址 | `curl -sS -X POST $A/login -H 'content-type: application/json' -d '{"username":"alice","password":"alice-dev"}'` | HTTP 200；`obs_pub_endpoint` 与步骤 1 一致 | PASS；HTTP 200 body={"token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhbGljZSIsImV4cCI6MTc4NzEyODQ1MywiaWF0IjoxNzg3MDQyMDUzfQ.MUkkvI0MWPm8GEDrbhOG7M7SFDxZILtAw074M2UDZ4k", "expires_at": "2026-08-19T08:34:13.695644Z", "nfs_host": "10.250.30.115", "nfs_export_path": "/mnt/dockerContainer/nfs/alice", "server_b_endpoint": "10.213.35.42:31000", "obs_pub_endpoint": "10.213.35.42:32000"} |
