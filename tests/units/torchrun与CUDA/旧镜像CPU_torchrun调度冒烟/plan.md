...
| 2 | 读 NFS 结果 | `cat /mnt/nfs/alice/jobs/last_run.txt` | 含 torch=2.4.1+cu121；device=cpu（5090 上预期）；有 loss= | PASS；退出码 0；输出：finished_at=2026-08-18T10:59:19.158752+00:00 device=cpu torch=2.4.1+cu121 loss=0.900481104850769 |
